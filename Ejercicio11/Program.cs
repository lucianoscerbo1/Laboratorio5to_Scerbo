    ...
    internal class Program
    {
        ...
        public class jugador : constantes
        {
            ...
            public void EntrarPorra()
            {
                ...
                if (tieneDinero() == true)
                {
                    Console.WriteLine(nombre + " entro a la porra! le quedan: $ " + dinero );
                ...
                {
                    Console.WriteLine(nombre + " NO ENTRO A LA PORRA POR FALTA DE DINERO, TIENE: $ " + dinero );
                }
            }
            ...
            public void Ganadores()
            {
                ...
                if (this.GanoPerdio == "gano")
                {
                    ...
                    Console.WriteLine(nombre + " gano la porra! tiene: $ " + this.dinero );
                ...
                else if (this.GanoPerdio == "perdio")
                {
                    ...
                    Console.WriteLine(nombre + " perdio la porra! sigue teniendo: $ " + this.dinero);
                ...
                {
                    this.dinero = this.dinero;
                    Console.WriteLine(nombre + " No gano ni perdio, el bote se acumula! sigue teniendo: $ " + this.dinero);
        ...
        static void Main(string[] args)
        {
            ...
            jugador j2 = new jugador("Fernando");
            jugador j3 = new jugador("Pablo");
